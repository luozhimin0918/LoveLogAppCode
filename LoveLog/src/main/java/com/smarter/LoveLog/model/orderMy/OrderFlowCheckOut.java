 ...
 */
public class OrderFlowCheckOut implements Serializable {
    /**
     * succeed : 1
     */
    ...
    /**
     * goods_list : [{"rec_id":"10329","user_id":"2","goods_id":"7","goods_name":"测试商品请勿购买","goods_sn":"MC000007","goods_number":"15","market_price":"50.00","goods_price":"50.00","goods_attr":"","is_real":"1","extension_code":"","parent_id":"0","is_gift":"0","is_shipping":"1","subtotal":"750.00","formated_market_price":"¥50.00","formated_goods_price":"¥50.00","formated_subtotal":"¥750.00","img_thumb":"http://www.aiderizhi.com/images/201605/thumb_img/7_thumb_G_1462991170239.jpg"}]
     * consignee : {"address_id":"2655","consignee":"樊康鹏","mobile":"15936219805","country":"1","province":"2","city":"52","district":"500","country_name":"中国","province_name":"北京","city_name":"北京","district_name":"东城区","address":"婆婆婆婆","zipcode":"","is_default":1}
     * payment_type : [{"id":"1","name":"在线支付","desc":"在线支付说明","status":"1","sort_order":"1"},{"id":"2","name":"货到付款","desc":"货到付款说明","status":"0","sort_order":"2"}]
     * shipping_list : [{"shipping_id":"1","shipping_code":"sf_express","shipping_name":"顺丰速运","shipping_desc":"时效领先，按需送达。","format_shipping_fee":"¥0.00","shipping_fee":0,"free_money":"¥300.00"},{"shipping_id":"10","shipping_code":"yunda_express","shipping_name":"韵达快递","shipping_desc":"价格适中，速度适中，性价比首选。","format_shipping_fee":"¥0.00","shipping_fee":0,"free_money":"¥39.00"}]
     * allow_use_bonus : 1
     * bonus : [{"id":"11872","sn":"N/A","name":"好面膜齐分享5元红包","amount":"¥5.00","min_order_amount":"¥50.00","start_time":"2016-05-12","end_time":"2016-06-12"},{"id":"11873","sn":"N/A","name":"好面膜齐分享5元红包","amount":"¥5.00","min_order_amount":"¥50.00","start_time":"2016-05-12","end_time":"2016-06-12"},{"id":"11875","sn":"N/A","name":"好面膜齐分享5元红包","amount":"¥5.00","min_order_amount":"¥50.00","start_time":"2016-05-12","end_time":"2016-06-12"},{"id":"11876","sn":"N/A","name":"好面膜齐分享2元红包","amount":"¥2.00","min_order_amount":"¥30.00","start_time":"2016-05-12","end_time":"2016-06-12"},{"id":"11885","sn":"N/A","name":"好面膜齐分享5元红包","amount":"¥5.00","min_order_amount":"¥50.00","start_time":"2016-05-12","end_time":"2016-06-12"},{"id":"11979","sn":"N/A","name":"好面膜齐分享5元红包","amount":"¥5.00","min_order_amount":"¥50.00","start_time":"2016-05-12","end_time":"2016-06-12"},{"id":"11980","sn":"N/A","name":"好面膜齐分享2元红包","amount":"¥2.00","min_order_amount":"¥30.00","start_time":"2016-05-12","end_time":"2016-06-12"}]
     * inv_content_list : [{"id":0,"value":"化妆品"},{"id":1,"value":"办公用品"}]
     * inv_type_list : [{"id":0,"value":"1 [1%]"},{"id":1,"value":"2 [1.5%]"}]
     * user_integral : 104
     * order_max_integral : 7500
     * default_pay_type_id : 1
     * default_pay_type_name : 在线支付
    ...
    public static class DataEntity implements Serializable{
        ...
        private int default_pay_type_id;
         ...
         * saving : 0
         * save_rate : 0%
         * goods_price_formated : ¥750.00
         * market_price_formated : ¥750.00
         * saving_formated : ¥0.00
         * free_shipping_left : -711
         ...
         * is_shipping : 1
         * subtotal : 750.00
         * formated_market_price : ¥50.00
         * formated_goods_price : ¥50.00
         * formated_subtotal : ¥750.00
         * img_thumb : http://www.aiderizhi.com/images/201605/thumb_img/7_thumb_G_1462991170239.jpg
         */
        ...
        private List<PaymentTypeEntity> payment_type;
        /**
         * shipping_id : 1
         * shipping_code : sf_express
         * shipping_name : 顺丰速运
         * shipping_desc : 时效领先，按需送达。
        ...
        private List<InvContentListEntity> inv_content_list;
        /**
         * id : 0
         * value : 1 [1%]
         */

        private List<InvTypeListEntity> inv_type_list;
        ...
        public void setDefault_pay_type_id(int default_pay_type_id) {
            this.default_pay_type_id = default_pay_type_id;
        }

        public void setDefault_pay_type_name(String default_pay_type_name) {
            this.default_pay_type_name = default_pay_type_name;
        }

        public void setDefault_shipping_id(int default_shipping_id) {
            this.default_shipping_id = default_shipping_id;
        }

        public void setDefault_shipping_name(String default_shipping_name) {
            this.default_shipping_name = default_shipping_name;
        }
        ...
        public void setPayment_type(List<PaymentTypeEntity> payment_type) {
        ...
        public void setInv_content_list(List<InvContentListEntity> inv_content_list) {
            this.inv_content_list = inv_content_list;
        }

        public void setInv_type_list(List<InvTypeListEntity> inv_type_list) {
            this.inv_type_list = inv_type_list;
        }
        ...
        public int getDefault_pay_type_id() {
            return default_pay_type_id;
        }

        public String getDefault_pay_type_name() {
            return default_pay_type_name;
        }

        public int getDefault_shipping_id() {
            return default_shipping_id;
        }

        public String getDefault_shipping_name() {
        ...
        public List<PaymentTypeEntity> getPayment_type() {
            return payment_type;
        }
        ...
        public List<InvContentListEntity> getInv_content_list() {
            return inv_content_list;
        }

        public List<InvTypeListEntity> getInv_type_list() {
        ...
        public static class PaymentTypeEntity implements Serializable{
            private String id;
            private String name;
            private String desc;
            private String status;
            private String sort_order;
            private boolean isSelceteItem;

            public boolean isSelceteItem() {
                return isSelceteItem;
            }

            public void setIsSelceteItem(boolean isSelceteItem) {
                this.isSelceteItem = isSelceteItem;
            }
        ...
        public static class ShippingListEntity implements Serializable{
        ...
        public static class InvContentListEntity implements Serializable {
            private int id;
        ...
        public static class InvTypeListEntity implements Serializable {
            private int id;
            private String value;
